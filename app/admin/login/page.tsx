...
/**
 * Admin login. Single password field, big button, error inline. Posts to
 * /api/admin/auth — the route applies the 200 ms artificial delay before responding.
 */
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-surface-warm px-6 py-12">
      ...
      >
        ...
        <p className="mt-1 text-sm text-ink-muted">Sign in to manage today's special.</p>
